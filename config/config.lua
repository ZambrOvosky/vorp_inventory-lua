...
Config = {
	...
	AddDollarItem            = false,   -- Should there be an item in inventory to represent dollars
	...
	OnPlayerRespawn          = {
		...
		Items = {
			...
			itemWhiteList = {}, -- dont delete these items
	...
	-- FIRST JOIN
	startItems               = {
		consumable_drink_coffee = 3, consumable_bread = 2, newspaper = 1, bussola = 1, mapa = 1,
	},
